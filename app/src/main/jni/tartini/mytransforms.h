...
class MyTransforms
{
  ...
  GstFFTF32 *planDataTime2FFT, *planDataFFT2Time;
  GstFFTF32 *planAutocorrTime2FFT, *planAutocorrFFT2Time;

  float *dataTemp;
  float *dataTime;
  GstFFTF32Complex *dataFFT;
  float *autocorrTime;
  GstFFTF32Complex *autocorrFFT;
 ...
 public:
  ...
  MyTransforms(GlobalData *gdata_);
